...
final class MatchScoreboardContextProvider implements ScoreboardContextProvider {
    ...
    MatchScoreboardContextProvider(PlayerStateRepository playerStateRepository, PlayerPresenceRepository playerPresenceRepository, PlayerScoreboardDataCache dataCache) {
