package com.stephanofer.prismapractice.ffa.command;
...
public final class FfaCommandDefinitions {

    private FfaCommandDefinitions() {
    }
    ...
    public static List<CommandSpec> create() {
        ...
        practice.executes(context -> {
            context.replyRich("<gold>PrismaPractice FFA</gold> <gray>- usá /prismapractice help</gray>");
        ...
        practice.child(CommandLiteralSpec.literal("info")
            ...
            .executes(context -> {
                context.replyRich("<aqua>Runtime:</aqua> <gray>ffa</gray>");
                return Command.SINGLE_SUCCESS;
            }));
